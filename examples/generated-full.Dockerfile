...
RUN apt-get update -qq && apt-get install -yq --no-install-recommends dcm2niix git-annex-standalone mrtrix \
    && apt-get clean \
    && rm -rf /var/lib/apt/lists/* /tmp/* /var/tmp/*
...
RUN echo '{ \
    ...
    \n    ] \
    \n  ], \
    \n  "generation_timestamp": "2017-11-07 14:05:04", \
