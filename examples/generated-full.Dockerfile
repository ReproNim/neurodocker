# Generated by Neurodocker v0.2.0-26-g01d1426.
#
...
#-------------------------
RUN conda create -y -q --name neuro --channel vida-nyu \
    	python=3.5.1 numpy pandas reprozip traits \
...
# Create conda environment
#-------------------------
RUN conda create -y -q --name py27 \
    	python=2.7 \
    && sync && conda clean -tipsy && sync
...
RUN echo '{ \
    ...
    \n    ] \
    \n  ], \
    \n  "generation_timestamp": "2017-08-31 22:55:51", \
    \n  "neurodocker_version": "0.2.0-26-g01d1426" \
